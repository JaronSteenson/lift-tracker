...
namespace LiftTrackerApi.Migrations
{
    ...
    public partial class LoadOriginalSchemaDump : Migration
    {
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        rememberToken = table.Column<string>(
                            type: "varchar(100)",
                            maxLength: 100,
                            nullable: true
                        ),
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        uuid = table.Column<Guid>(type: "char(36)", nullable: false),
                        workoutProgramRoutineId = table.Column<uint>(
                            type: "int unsigned",
                            nullable: true
                        ),
                        ...
                        updatedAt = table.Column<DateTime>(type: "timestamp", nullable: true),
                        deletedAt = table.Column<DateTime>(type: "timestamp", nullable: true),
                        bodyWeight = table.Column<decimal>(
                            type: "decimal(6,2)",
                            precision: 6,
                            nullable: true
                        ),
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        normalDay = table.Column<string>(
                            type: "enum('any','Monday','Tuesday','Wensday','Thursday','Friday','Saturday','Sunday')",
                            nullable: true,
                            defaultValueSql: "'any'"
                        ),
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        workoutSessionId = table.Column<uint>(
                            type: "int unsigned",
                            nullable: false
                        ),
                        routineExerciseId = table.Column<uint>(
                            type: "int unsigned",
                            nullable: true
                        ),
                        plannedWeight = table.Column<decimal>(
                            type: "decimal(6,2)",
                            precision: 6,
                            nullable: true
                        ),
                        plannedRestPeriodDuration = table.Column<uint>(
                            type: "int unsigned",
                            nullable: true
                        ),
                        notes = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        uuid = table.Column<Guid>(type: "char(36)", nullable: false),
                        sessionExerciseId = table.Column<uint>(
                            type: "int unsigned",
                            nullable: false
                        ),
                        ...
                        restPeriodDuration = table.Column<uint>(
                            type: "int unsigned",
                            nullable: true
                        ),
                        restPeriodStartedAt = table.Column<DateTime>(
                            type: "timestamp",
                            nullable: true
                        ),
                        restPeriodEndedAt = table.Column<DateTime>(
                            type: "timestamp",
                            nullable: true
                        ),
                        position = table.Column<uint>(type: "int unsigned", nullable: false),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "password_resets");

            migrationBuilder.DropTable(name: "RoutineExercises");

            migrationBuilder.DropTable(name: "SessionSets");

            migrationBuilder.DropTable(name: "Users");

            migrationBuilder.DropTable(name: "WorkoutProgramRoutines");

            migrationBuilder.DropTable(name: "SessionExercises");

            migrationBuilder.DropTable(name: "WorkoutPrograms");
