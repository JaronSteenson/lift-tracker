...
var require_rollbar_umd_min = __commonJS({
  "node_modules/rollbar/dist/rollbar.umd.min.js"(exports, module) {
    !(function(t, e) {
      ...
      return t = { 276: function() {
      ...
      }, 180: function(t2, e2, r) {
        var n, o, i;
        !(function(s, a) {
          "use strict";
          o = [r(124)], void 0 === (i = "function" == typeof (n = function(t3) {
            ...
            return { parse: function(t4) {
              ...
              return e4.stack.split("\n").filter((function(t4) {
                ...
                var r3 = e5.replace(/^\s+/, "").replace(/\(eval code/g, "("), n3 = r3.match(/ (\((.+):(\d+):(\d+)\)$)/), o2 = (r3 = n3 ? r3.replace(n3[0], "") : r3).split(/\s+/).slice(1), i2 = this.extractLocation(n3 ? n3[1] : o2.pop()), s2 = o2.join(" ") || void 0, a2 = ["eval", "<anonymous>"].indexOf(i2[0]) > -1 ? void 0 : i2[0];
                return new t3({ functionName: s2, fileName: a2, lineNumber: i2[1], columnNumber: i2[2], source: e5 });
              }), this);
              ...
              for (var r3 = /Line (\d+).*script (?:in )?(\S+)/i, n3 = e4.message.split("\n"), o2 = [], i2 = 2, s2 = n3.length; i2 < s2; i2 += 2) {
                ...
                a2 && o2.push(new t3({ fileName: a2[2], lineNumber: a2[1], source: n3[i2] }));
              }
              return o2;
              ...
              for (var r3 = /Line (\d+).*script (?:in )?(\S+)(?:: In function (\S+))?$/i, n3 = e4.stacktrace.split("\n"), o2 = [], i2 = 0, s2 = n3.length; i2 < s2; i2 += 2) {
                var a2 = r3.exec(n3[i2]);
                a2 && o2.push(new t3({ functionName: a2[3] || void 0, fileName: a2[2], lineNumber: a2[1], source: n3[i2] }));
              }
              return o2;
              ...
              return r3.stack.split("\n").filter((function(t4) {
                ...
                var r4, n3 = e4.split("@"), o2 = this.extractLocation(n3.pop()), i2 = n3.shift() || "", s2 = i2.replace(/<anonymous function(: (\w+))?>/, "$2").replace(/\([^)]*\)/g, "") || void 0;
                i2.match(/\(([^)]*)\)/) && (r4 = i2.replace(/^[^(]+\(([^)]*)\)$/, "$1"));
                var a2 = void 0 === r4 || "[arguments not available]" === r4 ? void 0 : r4.split(",");
                return new t3({ functionName: s2, args: a2, fileName: o2[0], lineNumber: o2[1], columnNumber: o2[2], source: e4 });
              }), this);
            } };
        ...
        !(function(i, s) {
          ...
          n = [], void 0 === (o = "function" == typeof (r = function() {
            ...
            var n2 = ["isConstructor", "isEval", "isNative", "isToplevel"], o2 = ["columnNumber", "lineNumber"], i2 = ["fileName", "functionName", "source"], s2 = ["args"], a = ["evalOrigin"], u = n2.concat(o2, i2, s2, a);
            function c(t4) {
            ...
            c.prototype = { getArgs: function() {
              ...
              var e4 = t4.indexOf("("), r3 = t4.lastIndexOf(")"), n3 = t4.substring(0, e4), o3 = t4.substring(e4 + 1, r3).split(","), i3 = t4.substring(r3 + 1);
              if (0 === i3.indexOf("@")) var s3 = /@(.+?)(?::(\d+))?(?::(\d+))?$/.exec(i3, ""), a2 = s3[1], u2 = s3[2], l2 = s3[3];
            ...
            for (var h = 0; h < i2.length; h++) c.prototype["get" + e3(i2[h])] = r2(i2[h]), c.prototype["set" + e3(i2[h])] = /* @__PURE__ */ (function(t4) {
              return function(e4) {
                this[t4] = String(e4);
              };
            })(i2[h]);
        ...
        "use strict";
        var n = r(702), o = r(817), i = { hostname: "api.rollbar.com", path: "/api/1/item/", search: null, version: "1", protocol: "https:", port: 443 };
        ...
        "use strict";
        var n = r(343), o = "undefined" != typeof window && window._rollbarConfig, i = o && o.globalAlias || "Rollbar", s = "undefined" != typeof window && window[i] && "function" == typeof window[i].shimId && void 0 !== window[i].shimId();
        ...
        "use strict";
        var n = r(562), o = r(702), i = r(815), s = r(802), a = r(349), u = r(477), c = r(509), l = r(860), p = r(417), h = r(172), f = r(61), d = r(303);
        function m(t3, e3) {
        ...
        var w = r(948), _ = r(677), x = { version: w.version, scrubFields: _.scrubFields, logLevel: w.logLevel, reportLevel: w.reportLevel, uncaughtErrorLevel: w.uncaughtErrorLevel, endpoint: w.endpoint, verbose: false, enabled: true, transmit: true, sendConfig: false, includeItemsInTelemetry: true, captureIp: true, inspectAnonymousErrors: true, ignoreDuplicateErrors: true, wrapGlobalEventHandlers: false };
        t2.exports = m;
      }, 677: (t2) => {
        "use strict";
        ...
        "use strict";
        var n = r(403), o = r(773), i = r(568), s = r(876), a = r(965), u = r(369), c = r(473);
        n.setComponents({ telemeter: o, instrumenter: i, polyfillJSON: s, wrapGlobals: a, scrub: u, truncation: c }), t2.exports = n;
      }, 568: (t2, e2, r) => {
        "use strict";
        var n = r(702), o = r(650), i = r(297), s = r(369), a = r(509), u = r(300), c = { network: true, networkResponseHeaders: false, networkResponseBody: false, networkRequestHeaders: false, networkRequestBody: false, networkErrorOnHttp5xx: false, networkErrorOnHttp4xx: false, networkErrorOnHttp0: false, log: true, dom: true, navigation: true, connectivity: true, contentSecurityPolicy: true, errorOnContentSecurityPolicy: false };
        function l(t3, e3) {
        ...
        s.prototype.get = function(t3, e3, r2, o2, i2) {
          ...
          var t3 = "undefined" != typeof window && window || void 0 !== o2 && o2, e3 = t3 && t3.Zone && t3.Zone.current, r2 = Array.prototype.slice.call(arguments);
          if (e3 && "angular" === e3._name) {
            var n2 = e3._parent, o2 = this;
            n2.run((function() {
        ...
        "use strict";
        t2.exports = { version: "2.26.4", endpoint: "api.rollbar.com/api/1/item/", logLevel: "debug", reportLevel: "debug", uncaughtErrorLevel: "error", maxItems: 0, itemsPerMin: 60 };
      }, 303: (t2, e2, r) => {
        "use strict";
        var n = r(180), o = new RegExp("^(([a-zA-Z0-9-_$ ]*): *)?(Uncaught )?([a-zA-Z0-9-_$ ]*): ");
        function i() {
          return null;
        }
        function s(t3) {
        ...
        t2.exports = function t3() {
          var e3, r2, o, i, s, a = {}, u = null, c = arguments.length;
        ...
        "use strict";
        var n = r(790), o = r(358), i = r(314), s = r(702);
