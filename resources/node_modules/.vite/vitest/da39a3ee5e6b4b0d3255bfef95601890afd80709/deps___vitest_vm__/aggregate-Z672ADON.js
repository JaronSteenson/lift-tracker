...
// node_modules/@newrelic/browser-agent/dist/esm/features/spa/aggregate/interaction-node.js
var MAX_NODES = 128;
var lastId = 0;
...
// node_modules/@newrelic/browser-agent/dist/esm/features/spa/aggregate/interaction.js
...
// node_modules/@newrelic/browser-agent/dist/esm/features/spa/aggregate/serializer.js
...
// node_modules/@newrelic/browser-agent/dist/esm/features/spa/aggregate/index.js
var {
  FEATURE_NAME,
  INTERACTION_EVENTS,
  MAX_TIMER_BUDGET,
...
var Aggregate = class extends AggregateBase {
  ...
  constructor(agentRef) {
    ...
    if (agentRef.runtime.session?.isNew) state.initialPageLoad.root.attrs.custom.isFirstOfSession = true;
    ...
    function saveInteraction(interaction) {
      ...
      handle(SUPPORTABILITY_METRIC_CHANNEL, ["Spa/Interaction/".concat(smCategory, "/Duration/Ms"), Math.max((interaction.root?.end || 0) - (interaction.root?.start || 0), 0)], void 0, FEATURE_NAMES.metrics, baseEE);
      if (!harvester) {
        warn(19);
        return;
      }
...
//# sourceMappingURL=aggregate-Z672ADON.js.map
