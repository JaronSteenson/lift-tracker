...
var Aggregate = class extends AggregateBase {
  ...
  constructor(agentRef) {
    ...
    defaultRegister("softNavFlush", (interactionId, wasFinished, softNavAttrs) => this.onSoftNavNotification(interactionId, wasFinished, softNavAttrs), this.featureName, this.ee);
  ...
  storeError(err, time, internal, customAttributes, hasReplay, swallowReason, targetEntityGuid) {
    ...
    if (this.shouldAllowMainAgentToCapture(targetEntityGuid)) handle("trace-jserror", jsErrorEvent, void 0, FEATURE_NAMES.sessionTrace, this.ee);
    ...
    if (this.shouldAllowMainAgentToCapture(targetEntityGuid)) {
      ...
      if (params.browserInteractionId && !params._softNavFinished) {
        ...
        this.#storeJserrorForHarvest(jsErrorEvent, params.browserInteractionId !== void 0, params._softNavAttributes);
      }
    }
  ...
  */
  ...
  onSoftNavNotification(interactionId, wasFinished, softNavAttrs) {
    if (this.blocked) return;
    this.bufferedErrorsUnderSpa[interactionId]?.forEach(
      (jsErrorEvent) => this.#storeJserrorForHarvest(jsErrorEvent, wasFinished, softNavAttrs)
...
//# sourceMappingURL=aggregate-IFAVMGDM.js.map
