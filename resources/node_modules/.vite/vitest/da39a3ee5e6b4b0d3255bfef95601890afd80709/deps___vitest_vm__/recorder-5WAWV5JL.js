...
var Recorder = class {
  ...
  getEvents() {
    ...
    return {
      events: [...this.#backloggedEvents.events, ...this.#events.events].filter((x2) => x2),
      type: "standard",
  ...
  audit(event, isCheckout) {
    ...
    if (!this.shouldFix) {
      if (incompletes > 0) {
        ...
        this.#warnCSSOnce();
        handle(SUPPORTABILITY_METRIC_CHANNEL, [missingInlineSMTag + "Skipped", incompletes], void 0, FEATURE_NAMES.metrics, this.parent.ee);
      }
    ...
    if (incompletes > 0) {
      stylesheetEvaluator.fix().then((failedToFix) => {
        ...
        handle(SUPPORTABILITY_METRIC_CHANNEL, [missingInlineSMTag + "Failed", failedToFix], void 0, FEATURE_NAMES.metrics, this.parent.ee);
        handle(SUPPORTABILITY_METRIC_CHANNEL, [missingInlineSMTag + "Fixed", incompletes - failedToFix], void 0, FEATURE_NAMES.metrics, this.parent.ee);
  ...
  clearTimestamps() {
    this.currentBufferTarget.cycleTimestamp = void 0;
  }
...
rrweb/dist/rrweb.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=recorder-5WAWV5JL.js.map
