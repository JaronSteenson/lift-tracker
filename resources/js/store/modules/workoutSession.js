...
export const getters = {
    ...
    exerciseHistory: (state) => (exerciseUuid) => {
        return state.exercisesHistory[exerciseUuid] || [];
    },
...
export const actions = {
    ...
    async fetchExerciseHistory({ state, commit, rootGetters }, exerciseUuid) {
        ...
        if (rootGetters['app/userIsLocalOnly']) {
            ...
            const response = await SessionExerciseService.getHistory(
                exerciseUuid
            );
...
const mutations = {
    ...
    updateExerciseHistory(state, { exerciseUuid, previousEntries }) {
        state.exercisesHistory[exerciseUuid] = previousEntries;
    },
